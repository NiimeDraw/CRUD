...
// 4. Siapkan kondisi pencarian jika ada keyword
$searchCondition = '';
if (!empty($search)) {
    // Penting: gunakan mysqli_real_escape_string untuk mengamankan input pencarian
    $searchSafe = mysqli_real_escape_string($conn, $search);
    $searchCondition = " WHERE nama LIKE '%$searchSafe%' ";
}

// 5. Hitung total data untuk pagination dengan memperhitungkan kondisi pencarian
$countQuery = "SELECT COUNT(*) as total FROM karakter $searchCondition";
...
// 7. Query mengambil data dengan LIMIT, OFFSET, dan kondisi pencarian
$query = "SELECT * FROM karakter $searchCondition ORDER BY id DESC LIMIT $offset, $limit";
...
<head>
  ...
  <style>
    ...
    .card-img-top {
      width: 100%;
      height: auto; /* Menyesuaikan tinggi gambar sesuai aspeknya */
    }
  </style>
</head>
<body>
...
<div class="main-content">
  <div class="container mt-5">
    <h1 class="mb-4">All Characters</h1>
    ...
    <?php
      // Pastikan keyword pencarian tetap tersimpan di URL pagination
